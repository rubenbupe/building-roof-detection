...
export const watershed = (feature, tensor, output_canvas) => {
...
export const renderPredictions = (feature, predictions, output_canvas) => {
  ...
  watershed(feature, tensor, output_canvas);
};

export const predictImage = (model, i, output_canvas) => {
  ...
  requestAnimationFrame(() => {
    renderPredictions(i, predictions, output_canvas);
    tf.engine().endScope();
  });
